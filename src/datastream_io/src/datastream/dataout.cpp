...
extern bool write_GNSSObsData_IPSStruct2ROSBag(const char *bag_outfilepath, const std::string gnss_obstopic, const std::string imu_topic, const std::list<gnss_common::IPS_OBSDATA> &gnss_obsdata, int bagmode)
{
    ...
    for (auto iter = gnss_obsdata.begin(); iter != gnss_obsdata.end(); ++iter)
    {
        ...
        datastreamio::RobotGVINS_GNSSObs obs_msg;
 ...
 *                        false               fail to write
 */
extern bool write_GNSSSolData_RobotGVINS2ROSBag(const char *bag_outfilepath, const std::string gnsssol_topic, const std::string imu_topic, const std::list<datastreamio::RobotGVINS_GNSSSol> &gnsssol_datas, int bagmode)
{
 ...
 *                        false               fail to write
 */
extern bool write_GNSSSolData_ROSFormat2ROSBag(const char *bag_outfilepath, const std::string gnsssol_topic, const std::string imu_topic, const std::list<datastreamio::RobotGVINS_GNSSSol> &gnsssol_datas, int bagmode)
{
